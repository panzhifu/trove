...
use gpui_kit::component::{ActiveTheme, Disableable as _, IconName, Sizable, ThemeMode, WindowExt};
    ...
    pub fn open(window: &mut Window, cx: &mut App, controller: Entity<LibraryController>) {
        window.open_dialog(cx, move |dialog, _, cx| {
            ...
            let settings = Settings::new("trove-settings")
                ...
                .page(appearance_page(&controller, cx))
...
fn appearance_page(controller: &Entity<LibraryController>, cx: &App) -> SettingPage {
