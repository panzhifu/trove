...
> 调研日期：2026-09-08 ｜ 最近更新：2026-09-10（标记 0.4 新增：3D 模型预览、视频无声播放、截图采集、批量格式转换）｜ 适用版本：Trove 0.4.0
>
...
**一句话总结：组织与检索内核已接近同类产品水准，收集入口基本补齐，3D 模型预览与视频无声播放已打通；缺口集中在「AI 自动化、时间线视图、批处理出口补全」几条线上。**
