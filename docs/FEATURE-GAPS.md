...
> 调研日期：2026-09-08 ｜ 最近更新：2026-09-16（第八批核对：AVIF/JPEG-XL 缩略图已实现；PLY 点云渲染 + 顶点色、媒体宽高比预设、系统托盘、浏览器扩展 MV3/Firefox、字体三行样卡、自动更新检查已入 0.4.1/0.4.2；同步 Eagle 4.0 正式版 AI 全家桶动态）｜ 适用版本：Trove 0.4.2
>
